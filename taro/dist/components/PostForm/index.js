...
var PostForm = (_temp2 = _class = function (_Taro$Component) {
  ...
  function PostForm() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PostForm.__proto__ || Object.getPrototypeOf(PostForm)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__2", "props", "handleSubmit", "__fn_onSubmit", "handleTitleInput", "__fn_onInput", "handleContentInput"], _this.customComponents = ["AtButton"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  return PostForm;
}(_taroWeapp2.default.Component), _class.$$events = ["funPrivatebzzzz", "funPrivateczzzz", "funPrivatedzzzz"], _class.$$componentPath = "components/PostForm/index", _temp2);
