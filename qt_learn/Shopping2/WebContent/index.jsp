					...
					<div class="col-md-3 col-md2">
						<div class="col-md1 simpleCart_shelfItem">
							<a href="jsp/goodsDescribed.jsp?gid=<%=goodsList.get(i).getGid()%>" target="_blank"> 
								<%String photoPath = "images/" + goodsList.get(i).getGname() + "1.jpg";%> 
							...
							<div class="price">
								<h5 class="item_price"><%=goodsList.get(i).getPrice()%>元</h5>
								<a href="jsp/addToCart.jsp?gid=<%=goodsList.get(i).getGid()%>&buyNumber=1" class="item_add">加入购物车</a>
								<div class="clearfix"></div>
							</div>
						</div>
					</div>
