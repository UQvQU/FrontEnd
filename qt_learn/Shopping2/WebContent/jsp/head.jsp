...
<script>
	function showtime() {
		var myDate = new Date();
		document.getElementById("time").innerHTML = myDate.getHours() + "点" + myDate.getMinutes() + "分" + myDate.getSeconds() + "秒";
			...
			<div class="container">
				...
				<div class="col-sm-4 header-left">
					<p class="log">
						<%
							if (uname != null) {
								...
								out.print("<a href=\"jsp/showMessage.jsp\" target=\"_blank\">"
										+ "个人信息" + "</a>");
								out.print("<a href=\"com/thx/servlet/LogoutServlet\" onClick=\"return key()\">"
										+ "退出" + "</a>");
							} else {
						...
						<a>在线人数:<%= OnlineCounter.getOnline()%></a>
					</p>
					<div class="cart box_1">
						<a href="jsp/shoppingCart.jsp"> 
									...
									<div class="col1">
										<div class="h_nav">
											...
											<ul>
												...
												%>
												<li>
													<a href="jsp/goodsDescribed.jsp?gid=<%=goods.getGid()%>" target="_blank"><%=goods.getGname()%></a>
												</li>
												<%
														}
													}
