...
<script type="text/javascript">
	function editHref() {
		...
		document.getElementById("carthref").href = document .getElementById("carthref").href + number;
	}
</script>
</head>
<body>
			...
			<div class="col-md-9">
						...
						<ul class="slides">
							...
							<li data-thumb="images/<%=photo[i]%>">
								<div class="thumb-image">
									<img src="images/<%=photo[i]%>" data-imagezoom="true" class="img-responsive">
								</div>
							</li>
							<%
									}
				...
				<div class="col-md-7 single-top-in">
					<div class="single-para simpleCart_shelfItem">
						...
						<div class="available">
							<h6>购买数量 :</h6>
							<input name="buyNumber" type="number" min="1" max=<%=number%> value="1" id="buyNumber">
						</div>
						<a id="carthref" href="jsp/addToCart.jsp?gid=<%=gid%>&buyNumber=" class="cart item_add" onclick="return editHref()">加入购物车</a>
					</div>
				</div>
			</div>
				...
				<div class="product-bottom">
					...
					<div class="product-go">
						<div class=" fashion-grid">
							<a href=<%=goodsHref%> target="_blank"> 
								<img class="img-responsive " src=<%=goodsPhoto%> alt="">
							</a>
						</div>
