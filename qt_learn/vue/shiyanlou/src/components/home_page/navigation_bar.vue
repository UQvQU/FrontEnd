      ...
      <div id="navigation_sign">
        <ul id="sign_menu">
          ...
          <div class="navigation_bar_unlogged_in_div" v-if="!login_state">
            <li class="navigation_li">
              <a href="#" id="sign_button" @click="change_show_state()">登录</a>
            </li>
            <li class="navigation_li">
              <a href="#" id="register_button" @click="change_show_state()">注册</a>
            </li>
          </div>
          <div class="navigation_bar_logged_div" v-if="login_state">
            ...
            <li class="navigation_feature_li avatar_li">
              <router-link :to="{name:'User', params:{id: user_info.id}}" class="navigation_feature_a navigation_avatar_a">
...
// login_state 在许多组件都需要用到，放入vuex中
export default {
  name: '',
  data () {
    return {}
