      ...
      <transition-group name="el-fade-in">
        <li class="item" v-for="(item, index) in articleList" :key="index">
          <a href="#" target="_blank">
            <img data-has-lazy-src="false" :data-src="item.img_url" src="../assets/bg.jpg" alt="" class="wrap-img img-blur-dong">
            <div class="content">
...
export default class Articles extends Vue{
  ...
  private async handleSearch(): Promise<void> {
    const data = await this.$https.get('http://yapi.demo.qunar.com/mock/51474/vue-ts-blog/articles').then(res => {
