<template>
  <div class="right slider">
    <img src="../assets/userLogo.jpg" alt="" class="right-logo">
    <div class="title">等你下课</div>
    <div class="tags">
      <div class="title">标签云</div>
      <router-link v-for="item in tagList"
                   class="item"
                   :key="item._id"
...
export default class Slider extends Vue{
  ...
  private async handleSearch(): Promise<void> {
    let data = await this.$https.get('http://yapi.demo.qunar.com/mock/51474/vue-ts-blog/tagList').then(res => {
      console.log(res)
      if (res.list.length) {
